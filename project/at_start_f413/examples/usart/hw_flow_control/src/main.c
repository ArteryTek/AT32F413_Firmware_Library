...
/** @addtogroup 413_USART_hw_flow_control USART_hw_flow_control
  * @{
  */
...
void usart_configuration(void)
{
  ...
  gpio_init_struct.gpio_pins = GPIO_PINS_2 | GPIO_PINS_1;
  ...
  gpio_init_struct.gpio_pins = GPIO_PINS_3 | GPIO_PINS_0;
